                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="login-content-dtls">
                                    <h2>Login</h2>
                                    <p>welcome Back! please sign in your account</p>
                                </div>
                                <form action="" class="p-3">
                                    <label for="" class="login-label">Enter Username</label>
                                    <input type="text" class="login-input-show" placeholder="Username">
                                    <label for="" class="login-label">Enter Password</label>
                                    <input type="text" class="login-input-show" placeholder="Password">
